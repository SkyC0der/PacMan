...
exports.LEVEL = LEVEL;
},{}],"ghostMove.js":[function(require,module,exports) {
"use strict";
...
function randomMovement(position, direction, objectExist) {
  var dir = direction;
  var nextMovePos = position + dir.movement; // Create Array from directions object keys
  ...
  while (objectExist(nextMovePos, _setup.OBJECT_TYPE.WALL) || objectExist(nextMovePos, _setup.OBJECT_TYPE.GHOST)) {
    ...
    dir = _setup.DIRECTIONS[key]; // set new move 
...
var _default = Pacman;
exports.default = _default;
},{"@babel/runtime/helpers/classCallCheck":"node_modules/@babel/runtime/helpers/classCallCheck.js","@babel/runtime/helpers/createClass":"node_modules/@babel/runtime/helpers/createClass.js","./setup":"setup.js"}],"Ghosts.js":[function(require,module,exports) {
"use strict";
...
var Ghost = /*#__PURE__*/function () {
  function Ghost() {
    ...
    this.pos = startPos;
    this.dir = _setup.DIRECTIONS.ArrowRight, this.speed = speed;
    this.timer = 0;
    this.isScared = false;
    this.rotation = false;
  }
...
function startGame() {
  ...
  var ghosts = [new _Ghosts.default(5, 188, _ghostMove.randomMovement, _setup.OBJECT_TYPE.BLINKY), new _Ghosts.default(5, 209, _ghostMove.randomMovement, _setup.OBJECT_TYPE.PINKY), new _Ghosts.default(5, 230, _ghostMove.randomMovement, _setup.OBJECT_TYPE.INKY), new _Ghosts.default(5, 251, _ghostMove.randomMovement, _setup.OBJECT_TYPE.CLYDE)];
...
},{"./setup":"setup.js","./ghostMove":"ghostMove.js","./GameBoard":"GameBoard.js","./Pacman":"Pacman.js","./Ghosts":"Ghosts.js","./sounds/munch.wav":"sounds/munch.wav","./sounds/pill.wav":"sounds/pill.wav","./sounds/game_start.wav":"sounds/game_start.wav","./sounds/death.wav":"sounds/death.wav","./sounds/eat_ghost.wav":"sounds/eat_ghost.wav"}],"node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
...
if ((!parent || !parent.isParcelRequire) && typeof WebSocket !== 'undefined') {
  ...
  var ws = new WebSocket(protocol + '://' + hostname + ':' + "44369" + '/');
